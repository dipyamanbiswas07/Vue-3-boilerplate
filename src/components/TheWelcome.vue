...
<template>
  <div class="welcome">
    ...
    <p>
      You've successfully created a Vue 3 project with TypeScript, Vite, Vue Router, and Pinia. This
      boilerplate includes modern development tools and best practices.
    </p>
